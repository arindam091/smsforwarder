...
public class Rules {
    ...
    public Rules(int id,String from_num,String from_num_name,String to_num,String to_num_name,int cond, String body_text){
    ...
    public Rules(String from_num,String from_num_name, String to_num,String to_num_name,int cond, String body_text){
        Log.d("INDB","In rules");
        this.from_num=from_num;
        this.from_num_name = from_num_name;
        this.to_num = to_num;
    ...
    public Rules( int cr_id, String cr_from_num,String from_num_name, String cr_to_num, String to_num_name,String cr_cond, String cr_body_text){
        Log.d("INDB","In rules");
